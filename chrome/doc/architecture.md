...
The storage key for a given puzzle should be the string `record-` followed by the puzzle identifier. See the [log format](../../doc/log-format.md) documentation for how the identifier is constructed.
